 ...
 */
public class LightCastersPointRenderer extends BaseRenderer {
    private String vertexLightShaderCode, fragmentLightShaderCode;
    private float[] mLightPosInModelSpace = new float[]{0f, 0.4f, 2f, 1f};
    ...
    public LightCastersPointRenderer(Context context) {
        super(context);
        vertexShaderCode = OpenGLUtil.getShaderFromResources(context, R.raw.light_casters_point_vertex);
        fragmentShaderCode = OpenGLUtil.getShaderFromResources(context, R.raw.light_casters_point_fragment);
